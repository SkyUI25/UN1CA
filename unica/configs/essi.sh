...
# Galaxy S22+ (Exynos) (One UI 7.0)
SOURCE_ASSERT_MODEL="SM-S906B"
SOURCE_CSC="EUX"
SOURCE_IMEI="350330051234562"
SOURCE_FIRMWARE="${SOURCE_ASSERT_MODEL}/${SOURCE_CSC}/${SOURCE_IMEI}"
SOURCE_FIRMWARE_PATH="${SOURCE_ASSERT_MODEL}_${SOURCE_CSC}"
...
SOURCE_DVFSAPP_CONFIG_SSRM_POLICY_FILENAME="siop_g0s_exynos2200"
